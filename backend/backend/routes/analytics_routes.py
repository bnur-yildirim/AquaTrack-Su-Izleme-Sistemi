...
from config import LAKE_INFO, KEY_BY_ID, SPECTRAL_PROFILES, BASE_QUALITY_SCORES
...
def lake_quality_analytics(lake_id):
    ...
    try:
        ...
        while current_date <= end_date:
            # Göl tipine göre temel kalite
            base_quality = BASE_QUALITY_SCORES.get(lake_numeric_id, 60)
...
def lake_spectral_analytics(lake_id):
    ...
    try:
        ...
        base_profile = SPECTRAL_PROFILES.get(lake_numeric_id, SPECTRAL_PROFILES[141])
