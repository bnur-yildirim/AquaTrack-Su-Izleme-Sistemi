...
// Göl fotoğrafları - public klasöründeki yerel görseller
const LAKE_PHOTOS = {
...
export default function MapPage({ onLakeSelect, setCurrentPage, setSearchParams, selectedLake: selectedLakeProp }) {
  ...
  return (
    <div style={{ position: 'relative', height: '100%', width: '100%' }}>
      ...
      {/* Gelişmiş Panel - Resim + Yazılar Üst Üste */}
      {(selectedLake || selectedLakeProp) && (
        <div 
          ...
          onClick={(e) => {
            // Panel'e tıklayınca sayfayı kaydır
            e.stopPropagation();
        ...
        >
          ...
          <div style={{
            ...
            {/* Fotoğraf üzerinde göl adı - Ortalanmış */}
            <div style={{
              position: 'absolute',
              bottom: '0',
              left: '0',
          ...
          <div style={{
            ...
            <button
              ...
              onClick={(e) => {
                e.stopPropagation(); // Panel tıklamasını engelle
