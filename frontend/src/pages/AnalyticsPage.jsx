...
export default function AnalyticsPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-blue-900 to-slate-900">
        ...
        <div className="relative container mx-auto px-4 py-12">
          <div className="text-center mb-8">
            <div className="inline-block mb-4">
              ...
              <div className="w-32 h-1.5 bg-gradient-to-r from-blue-500 to-green-500 mx-auto rounded-full"></div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-5xl mx-auto">
              {Object.entries(summary).map(([horizon, data]) => (
                <div key={horizon} className="relative group">
                  <div className="absolute inset-0 bg-gradient-to-r from-blue-500 to-green-500 rounded-2xl blur opacity-75 group-hover:opacity-100 transition"></div>
                  <div className="relative bg-slate-800 p-6 rounded-2xl border border-slate-700">
                    ...
                    <div className="text-4xl font-black text-white mb-3">
                      {data.avg_score.toFixed(1)}<span className="text-2xl text-blue-300">/100</span>
                    </div>
                    <div className="flex items-center gap-2 text-sm">
                      <div className="flex-1">
                        <div className="flex justify-between mb-1">
                          <span className="text-green-400">✓ Mükemmel</span>
                          <span className="text-white font-bold">{data.excellent}</span>
                        </div>
                        <div className="flex justify-between">
                          <span className="text-blue-400">✓ İyi</span>
                          <span className="text-white font-bold">{data.good}</span>
                        </div>
                      </div>
                    </div>
      ...
      {/* Navigation Tabs */}
      <div className="sticky top-0 z-10 bg-slate-900/95 backdrop-blur-lg border-b border-slate-800 shadow-xl">
          ...
          <div className="space-y-8">
            ...
            <div className="bg-slate-800 rounded-2xl border border-slate-700 overflow-hidden">
              <div className="bg-gradient-to-r from-blue-600 to-green-600 p-6">
                ...
                <p className="text-blue-100 mt-2">Overfitting önleme ve optimizasyon sonuçları</p>
              </div>
              <div className="p-8">
                <ModelComparisonCard />
              </div>
            ...
            <div className="bg-slate-800 rounded-2xl border border-slate-700 overflow-hidden">
              <div className="bg-gradient-to-r from-purple-600 to-pink-600 p-6">
                ...
                <p className="text-purple-100 mt-2">Model genelleştirme yeteneği analizi</p>
              </div>
              <div className="p-8">
            ...
            <div className="bg-slate-800 rounded-2xl border border-slate-700 overflow-hidden">
              <div className="bg-gradient-to-r from-orange-600 to-red-600 p-6">
                ...
                <p className="text-orange-100 mt-2">Göl büyüklüğünden bağımsız başarı skorları</p>
              </div>
              <div className="p-8">
                <UnifiedMetricsTable />
              </div>
        ...
        {activeTab === 'lakes' && (
          <div className="bg-slate-800 rounded-2xl border border-slate-700 overflow-hidden">
            <div className="bg-gradient-to-r from-emerald-600 to-teal-600 p-6">
              ...
              <p className="text-emerald-100 mt-2">7 göl için detaylı model başarı karşılaştırması</p>
            </div>
            <div className="p-8">
        ...
        {activeTab === 'seasonal' && (
          <div className="bg-slate-800 rounded-2xl border border-slate-700 overflow-hidden">
            <div className="bg-gradient-to-r from-amber-600 to-orange-600 p-6">
              ...
              <p className="text-amber-100 mt-2">Kış, İlkbahar, Yaz ve Sonbahar dönemlerinde model başarısı</p>
            </div>
            <div className="p-8">
          ...
          <div className="space-y-8">
            ...
            <div className="bg-slate-800 rounded-2xl border border-slate-700 overflow-hidden">
              <div className="bg-gradient-to-r from-indigo-600 to-purple-600 p-6">
                ...
                <p className="text-indigo-100 mt-2">Her göl için veri miktarı ve kalite analizi</p>
              </div>
              <div className="p-8">
                <DataQualityAnalysis />
              </div>
            ...
            <div className="bg-slate-800 rounded-2xl border border-slate-700 overflow-hidden">
              <div className="bg-gradient-to-r from-cyan-600 to-blue-600 p-6">
                ...
                <p className="text-cyan-100 mt-2">Model tahminlerinde en etkili 40 özellik</p>
              </div>
              <div className="p-8">
      ...
      <div className="bg-slate-900 border-t border-slate-800 mt-12">
        <div className="container mx-auto px-4 py-8">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 text-center">
            <div>
              <div className="text-3xl font-black text-blue-400">7</div>
              <div className="text-sm text-slate-400 mt-1">Göl Analizi</div>
            </div>
            <div>
              <div className="text-3xl font-black text-green-400">3</div>
              <div className="text-sm text-slate-400 mt-1">Horizon Modeli</div>
            </div>
            <div>
              <div className="text-3xl font-black text-purple-400">40</div>
              <div className="text-sm text-slate-400 mt-1">Optimize Feature</div>
            </div>
            <div>
              <div className="text-3xl font-black text-orange-400">8,109</div>
              <div className="text-sm text-slate-400 mt-1">Veri Noktası</div>
            </div>
          </div>
        </div>
      </div>
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
      {lakes.map(lake => {
        ...
        const colors = {
          ...
          limited: 'from-orange-500 to-red-600'
        };
        ...
        return (
          <div key={lake.id} className="relative group">
            ...
            <div className="relative bg-slate-900 p-4 rounded-xl border border-slate-700">
              <div className="text-sm text-slate-400 mb-1">{lake.name}</div>
              <div className="text-3xl font-black text-white mb-2">{lake.samples}</div>
              <div className="text-xs text-slate-400">veri noktası</div>
...
function FeatureImportanceChart() {
  ...
  if (!features) return <div className="text-slate-400">Yükleniyor...</div>;
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
        {features.slice(0, 10).map((feature, index) => (
          <div key={index} className="relative overflow-hidden">
            <div className="absolute inset-y-0 left-0 w-1 bg-gradient-to-b from-blue-500 to-green-500"></div>
            <div className="bg-slate-900 p-4 rounded-lg border border-slate-700 pl-6">
              <div className="flex items-center justify-between">
                <div>
                  <div className="text-xs text-slate-500 mb-1">#{index + 1}</div>
                  <div className="font-mono text-sm text-blue-300">{feature}</div>
                </div>
