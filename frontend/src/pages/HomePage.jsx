                  ...
                  <div style={{
                    ...
                    <div>
                      <div style={{
                        ...
                        {metrics.data.H1 ? (metrics.data.H1.avg_score * 100).toFixed(1) : '99.7'}%
                      </div>
                      <div style={{
                        fontSize: '10px',
                        color: COLORS.medium,
                    ...
                    <div>
                      <div style={{
                        ...
                        {metrics.data && metrics.data.H1 && metrics.data.H2 && metrics.data.H3 ? (
                          ((metrics.data.H1.avg_wmape + metrics.data.H2.avg_wmape + metrics.data.H3.avg_wmape) / 3).toFixed(1)
                        ) : '2.8'}%
                      </div>
                      <div style={{
                        fontSize: '10px',
