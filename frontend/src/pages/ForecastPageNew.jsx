            ...
            <div>
              ...
              <ResponsiveContainer width="100%" height={400}>
                <RadialBarChart 
                  ...
                  barSize={22}
                  data={(() => {
                    // MongoDB'den gelen gerçek horizon ortalamalarını kullan
                    const avgH1 = data.horizonComparison?.H1?.avg_score ? (data.horizonComparison.H1.avg_score * 100) : 99.7
                    const avgH2 = data.horizonComparison?.H2?.avg_score ? (data.horizonComparison.H2.avg_score * 100) : 99.87
                    const avgH3 = data.horizonComparison?.H3?.avg_score ? (data.horizonComparison.H3.avg_score * 100) : 99.88
                    ...
                    return [
                      ...
                      { 
                        name: 'CatBoost Ortalama', 
                        value: parseFloat(((avgH1 + avgH2 + avgH3) / 3).toFixed(1)),
                        fill: '#10b981'
                      }
                    ]
                  })()}
              ...
              <div style={{
                ...
                <strong style={{ color: '#1e40af' }}>Radial Bar Analizi:</strong> MongoDB'den gelen gerçek model doğruluk skorları. 
                H1, H2, H3 horizon'larının R² değerleri ve CatBoost ortalaması gösteriliyor.
              </div>
            </div>
          </div>
        )}
